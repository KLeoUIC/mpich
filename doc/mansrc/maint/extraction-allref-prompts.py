...
def generateDescription(funcMap, subMap, model, doc) -> None:
    if doc == "free":
        outPath = path.join(getcwd(), "doc/mansrc/maint/ai_prompt/free_prompt.txt")
    elif doc == "content":
        outPath = path.join(getcwd(), "doc/mansrc/maint/ai_prompt/content_prompt.txt")
    else: # lengthNcontent
        outPath = path.join(getcwd(), "doc/mansrc/maint/ai_prompt/lengthNcontent_prompt.txt")
    for func in funcMap:
